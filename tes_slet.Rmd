...
```{r preprocessing, fig.height=5, fig.width=10}
poke_ml <- poke %>% 
...
#kable(list(data.frame("Model"="Logistic"),conf_log, data.frame("Model"="lasticNet"), conf_glm, conf_svm, conf_raf, conf_lda))
...
#kable(tibble("M"           = c("True Positive", "Type I", "Type II", "False Negative"), 
#                 "Elastic Net" = c(conf_glm),
#                 "Logistic Regression"= c(conf_log),
#                 "Support Vector Machines" = c(conf_svm),
#                 "Random Forrest" = c(conf_raf),
#                 "Linear Diskriminant Analysis" = c(conf_lda)), caption = "Confision matrices tabel")
