...
trips_s$country_code[trips_s$country_code == "UK"] <- "GB" # United Kingdom coded as both UK and GB
trips_s$country_code[trips_s$country_code == ""] <- "empty" # Empty country codes coded as africa in countrylist
